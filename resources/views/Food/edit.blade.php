<x-app>
    ...
    <x-auth-card>
        ...
        <form method="POST" action="/food/{{ $food->id }}"  enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!--title -->
            <div>
                ...
                <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" placeholder="Example: spamniidhj" value="{{ $food->title}}" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="logo" class="block mt-1 w-full" type="file" name="logo" value="{{$food->logo}}" required />
                <img class="w-48 mr-6 mb-2" src="{{$food->logo ? asset('storage/' . $food->logo) : asset('image/dragon.png') }}" alt="">
