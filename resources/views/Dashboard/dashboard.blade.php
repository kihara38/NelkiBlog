<x-app>
 <div class="grid grid-cols-5 p-5">
    <div class="border-4 rounded-xl bg-slate-200 border-blue-400 hover:border-lime-300 col-span-1 mr-3">
        <div class="flex flex-col p-10 text-lg">
        <a
        href="{{ __('dashboard') }}"
        class="lg:w-auto w-full px-3 py-2 rounded text-gray-400 items-center justify-center hover:text-blue-400"
      >
        <span><i class="fa-solid fa-gauge pr-2"></i>DASHBOARD</span>
      </a>
      ...
      <a
        ...
        class="lg:w-auto w-full px-3 py-2 rounded text-gray-400 items-center justify-center hover:text-blue-400"
      >
        <span><i class="fa-solid fa-users pr-3"></i>users</span>
      </a>
      <a
        href="{{ __('blog') }}"
        class="lg:w-auto w-full px-3 py-2 rounded text-gray-400 items-center justify-center hover:text-blue-400"
      >
        <span><i class="fa-solid fa-blog pr-3"></i>Blogs</span>
      </a>
      <a
        href="#"
        class="lg:w-auto w-full px-3 py-2 rounded text-gray-400 items-center justify-center hover:text-blue-400"
      >
        <span><i class="fa-solid fa-martini-glass-citrus pr-3"></i>Cocktails</span>
      </a>
      <a
        href="#"
        class="lg:w-auto w-full px-3 py-1 rounded text-gray-400 items-center justify-center hover:text-blue-400"
      >
        <span><i class="fa-solid fa-bowl-rice pr-3"></i>food</span>
      </a>
        </div>
    </div>
    <div class="border-4 rounded-xl bg-slate-200  border-blue-400 hover:border-lime-300 col-span-4 mr-3">
