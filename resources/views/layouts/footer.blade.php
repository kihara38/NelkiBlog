<footer class="flex justify-evenly  bg-gray-700 flex-wrap bottom-0">
    <div class="flex flex-col">
        <img class="rounded-circle" style="height:2rem; " src="{{ asset('image/logo.png') }}">
        <h3>NELKI</h3>
    </div>
